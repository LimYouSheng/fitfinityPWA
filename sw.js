const CACHE='fitfinity-staff-ui-v57-section-order';
const SHELL=[
  './',
  './?staff=1',
  './assets/css/core.css',
  ...
  './assets/css/v037-layout-edit-fixes.css',
  './assets/css/v038-form-cleanup.css',
  './assets/css/v039-responsive-cleanup.css',
  './assets/css/v040-responsive-consistency.css',
  './assets/css/v041-remuneration-equal-columns.css',
  './assets/css/v042-exercise-search-remuneration.css',
  './assets/css/v044-precanonical-cleanup.css',
  './assets/css/v045-birthday-polish.css',
  './assets/css/v047-form-sections.css',
  './assets/css/v048-permissions-status-contact.css',
  './assets/css/v049-client-profile-schedule.css',
  './assets/css/v050-schedule-requests.css',
  './assets/css/v051-requests-reset.css',
  './assets/css/v052-trainer-autonomy.css',
  ...
  './assets/js/v037-layout-edit-fixes.js',
  './assets/js/v038-form-cleanup.js',
  './assets/js/v039-responsive-cleanup.js',
  './assets/js/v040-responsive-consistency.js',
  './assets/js/v042-exercise-search-remuneration.js',
  './assets/js/v044-precanonical-cleanup.js',
  './assets/js/v048-permissions-status-contact.js',
  './assets/js/v049-client-profile-schedule.js',
  './assets/js/v050-schedule-requests.js',
  './assets/js/v051-requests-reset.js',
  './assets/js/v052-trainer-autonomy.js',
  './assets/js/v053-package-progress.js',
  './assets/js/v054-session-acknowledgement.js',
  './assets/css/v054-session-acknowledgement.css',
  './assets/js/v055-freeze-polish.js',
  './assets/css/v055-freeze-polish.css',
  './assets/js/v056-freeze-polish.js',
  './assets/css/v056-freeze-polish.css',
  './icons/icon-192.png',
  './icons/icon-512.png',
